...
namespace GameOfLife.CSharp.Engine.Tests
{
    public class IWorldExtensionsTests
    {
        ...
        //    bool actual = ImmutableGridExtensions.IsValidIndex(moved, row, column);
        ...
        //{
        //    // Act, Assert
        //    Assert.Throws<ArgumentNullException>(() => ImmutableGridExtensions.IsInBounds(null, 0, 0));
        //}
        ...
        //    // Act
        //    IWorld moved = world.Move(left, top);
        //    bool actual = ImmutableGridExtensions.IsInBounds(moved, row, column);
